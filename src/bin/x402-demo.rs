...
const TARGETS: &[Target] = &[
    Target {
        ...
        detail: "Free. Metered and passed straight through — a price of zero is still a policy.",
        path: "/free/graphql",
        method: "POST",
    ...
    Target {
        ...
        detail: "A binary protocol nobody else gates. Different price, different receiving wallet, same filter.",
    ...
    Target {
        ...
        detail: "Also has no payment code. Returns 503 on purpose: verified, served a failure, and NOT charged.",
        path: "/boom",
        method: "POST",
        content_type: "application/json",
        body: "{}",
    ...
    Target {
        ...
        upstream: "this box, port 8402",
        detail: "An ordinary HTTP handler with NO payment code of its own. The gateway sells it; the app never finds out.",
        path: "/spin",
        method: "POST",
        content_type: "application/json",
        body: "{}",
